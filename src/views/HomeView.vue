  ...
  <div class="bg-[#121212] text-gray-100 font-sans">
    ...
    >
      ...
      >
        ...
        >
          <Box
            class="mx-auto mb-5 text-emerald-500 opacity-80 hover:opacity-100 transition-opacity"
            :size="52"
          />
          <h3
              ...
              >
                ...
                <div class="space-y-6">
                  <div>
                    ...
                    <p class="mt-3 text-gray-100">B.Tech in Computer Science</p>
                  </div>
                </div>
              </div>
              <div
    ...
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div
          ...
          :key="project.id"
          class="relative dark:bg-gray-800 rounded-2xl shadow-lg group overflow-hidden transition-all duration-300 hover:shadow-2xl min-h-[300px] flex flex-col"
          data-aos="fade-up"
        ...
        >
          ...
          <div class="relative overflow-hidden flex-shrink-0">
            ...
            <!-- <div
              class="absolute inset-0 border-4 border-transparent group-hover:border-emerald-500/40 rounded-2xl transition-all duration-300"
            ></div> -->
          </div>
          <!-- Content -->
          <div class="p-6 flex flex-col flex-grow">
            <div class="flex items-center justify-between">
              <h3
                class="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white group-hover:text-emerald-500 transition-colors duration-200"
              >
                {{ project.title }}
              </h3>
              <router-link
                to="/portfolio"
                class="flex items-center gap-2 text-emerald-500 dark:text-emerald-400 hover:text-emerald-600 dark:hover:text-emerald-300 text-sm md:text-base font-medium transition-all duration-200 group/link"
                :aria-label="`View details for ${project.title} project`"
              >
                See More
                <svg
                  class="w-5 h-5 text-emerald-500 transition-transform duration-200 group-hover/link:translate-x-1"
...
const projects = ref([
  {
    ...
    description: "A vibrant and modern logo created for a tech startup.",
    link: "/portfolio/logo",
  },
  {
    id: 2,
    ...
    description: "Dynamic animations for a promotional video campaign.",
  ...
  },
  {
    ...
    alt: "Flyer Design Project",
    description: "Eye-catching flyers for a local event promotion.",
    link: "/portfolio/flyer",
  },
  {
    id: 4,
    title: "3D",
    ...
    description: "Detailed 3D models for an architectural visualization.",
    link: "/portfolio/3d",
  },
]);
